...
{
    internal class BaseQpivParameterValidationErrorAttribute : BaseQpivAttribute
    {
        public BaseQpivParameterValidationErrorAttribute(params string[] parameterNames) : base(parameterNames)
        {
        }
