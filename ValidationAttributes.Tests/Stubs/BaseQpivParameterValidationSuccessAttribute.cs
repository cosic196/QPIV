...
{
    internal class BaseQpivParameterValidationSuccessAttribute : BaseQpivAttribute
    {
        public BaseQpivParameterValidationSuccessAttribute(params string[] parameterNames) : base(parameterNames)
        {
        }
