...
namespace QPIV.ValidationAttributes.Tests
{
    public class OrAttributeTests
    {
        ...
        public void Should_Return_True_When_Only_One_Parameter_Is_Set()
        {
            ...
            var attribute = new OrAttribute(SimpleModel.Property1Name, SimpleModel.Property2Name, SimpleModel.FieldName);
        ...
        [Fact]
        public void Should_Return_True_Multiple_Parameters_Are_Set()
        {
            var model = new SimpleModel()
            {
                SimpleModelProperty1 = 1,
